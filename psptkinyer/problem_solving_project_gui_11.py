...
class problem_solving_program(quadrants_of_program):
    ...
    def __init__(self):
        if __name__ == "__main__":
            ...
            #subprocess.Popen(["python", r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\Coding\business_process_management\inputs\upload_local_pyauto_scripts_not_on_website_database.py"])
            ...
            #subprocess.Popen(["python", r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\Coding\business_process_management\inputs\backup_both_pyauto_action_and_usable_table_to_big_black_from_website_among_oher_tables.py"])
            ...
            #create_pyautogui_file_of_inputs_and_video_folder=r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\Coding\automating_coding\generate_pyauto_gui_files"
            ...
            #username="jross77"
            #host="192.168.2.209"
            #listneer_foleder=r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\Coding\problem_solving_project\pyautogui_listener"
            ...
            #self.subprocess_run_script_remotely(scp_command_list)
            #doc2ui = [f"ssh",  f"{username}@{host}","dos2unix","/home/jross77/Documents/pyautogui_listener/pyauto_listener_bash.sh"]
            #self.subprocess_run_script_remotely(doc2ui)         
            #ssh_command = [f"ssh",  f"{username}@{host}",f"bash /home/jross77/Documents/pyautogui_listener/pyauto_listener_bash.sh"]# put the script you want to run here

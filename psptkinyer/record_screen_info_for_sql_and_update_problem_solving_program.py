...
class record_screen_info_for_sql_and_update_problem_solving_program_functions():
    def __init__(self):
        """ """
        import time
    ...
    def update_problem_solving_program_and_record_screen_for_additonal_problem_data(self,none):
        """ """
    ...
    def screen_record(self,screen_shot_time,xy_str):
        import pyautogui
        import cv2
        import numpy as np
        import win32gui
    ...
    def mouse_pynput_on_click(self,x, y, button, pressed):
        ...
        if self.counterr>=4:
            if button == mouse.Button.left:
                query_time= time.time()
                screen_recording_info_dic=self.screen_record(query_time,xy_str)
    ...
    def update_problem_solving_program_to_problem_being_solved_based_on_screenshot_info_nn(self,screen_recording_info_dic):
        """build a nn here to update information on screen like upload the blender file related to the problem
        update the info in the proble solving listboxes
        ssh into other computer to generate blender file
        update values in listboxs of 
        """

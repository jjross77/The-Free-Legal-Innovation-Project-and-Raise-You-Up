# -*- coding: utf-8 -*-
"""
Created on Tue Oct 15 03:29:43 2024
...
if __name__ == '__main__':
    ...
    ema.create_table_sql(column_name_data_type_dic,table_name="strategy_table")
    CREATE TABLE strategy_table(
"id" bigserial,
"problem_being_solved" text ,
"problem_id" text,
"question_or_tool_for_strategy" text,
"problem_web_variables" text,
"transformations" text,
"effects" text,
"time_found" text,
"actions" text,
"problem_tree_placement" text

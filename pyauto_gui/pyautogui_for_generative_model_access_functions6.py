...
class pyautogui_for_generative_model_access_functions_child(pyautogui_for_generative_model_access_functions):
    ...
    def mouse_pynput_on_click(self,x, y, button, pressed):
        ...
        ## record screen stuff adding in here 
        self.counterrrr+=1
...
xdotool mousemove 100 200 
         ...
         # transfer    
    def run_pyautogui_creation_script_on_all_other_computers_create_script_locally_to_ensure_correct_pixels(self,previous_active_window,previous_active_window_url,timee,dir_to_store_script,dir_to_store_script_linux,remote=False):
        ...
        for host, user_name, in zip(host_list,user_name_list):
            process_listner_list=self.exe_pyautogui_creation_script_on_other_computers_sub(user_name,host,remote_computer_script_dic,dir_to_store_script_linux,bash_file_name,bash_file_name_linux)
        ...
        # do the subprocessing thing here
        for host, user_name, in zip(host_list,user_name_list):
    ...
    def create_pyautogui_file_of_inputs_and_video(self,previous_active_window,previous_active_window_url, remote=False):
        ...
        if remote==False:
            ...
            try:
                ...
                #try:
                self.run_pyautogui_creation_script_on_all_other_computers_create_script_locally_to_ensure_correct_pixels(previous_active_window,previous_active_window_url,timeee,self.dir_to_store_script,self.dir_to_store_script_linux,remote=remote)
            except Exception as E:
                print(E)                
                print('Failed')

# -*- coding: utf-8 -*-
"""
Created on Sun Feb 26 17:04:30 2023
...
def Run_model():
    ...
    if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\try.pickle") == True:
        with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\try.pickle","rb") as ff:
    ...
    for i in range(9516, final_row_value):
    ...
    for  sentence_2, case_numm, label1, label2 in zip(sentence_list, case_start_list, label_1_for_good_or_not_list, label_2_for_sentence_type_list):
        print(i)
        #print(num_of_embeddings)
        ...
        #if i > num_of_embeddings:
        with open(r"D:\HPSCANS\existing_sentence_list_4.txt","a" , encoding="utf-8" ) as fff:
            fff.write(f"\n {existing_sentences} \n")
        ...
        try:
            ...
            if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\try.pickle") == True:
                ...
                with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\try.pickle","wb") as f:
    ...
    with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\try.pickle","wb") as fff:
        pickle.dump(dictt_of_sentence_embeddings, fff, pickle.HIGHEST_PROTOCOL)

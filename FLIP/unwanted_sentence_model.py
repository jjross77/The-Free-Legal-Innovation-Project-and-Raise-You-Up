# -*- coding: utf-8 -*-
"""
Created on Mon Jul 24 18:15:54 2023
...
cur = conn.cursor()
cur.execute( f""" SELECT word, embedding, labels
                   FROM non_sentence_labels 
                   limit 50000
                    ;""")
...
torch.save(model.state_dict(), r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\Kimlichcova\un_wanted_model.pth")

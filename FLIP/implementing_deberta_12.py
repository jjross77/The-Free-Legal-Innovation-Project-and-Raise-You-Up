# -*- coding: utf-8 -*-
"""
Created on Thu Mar  2 01:18:44 2023
...
def Run_model():
    ...
    if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\existing_senteces_and_current_sentence_new.pickle") == True:# if_existing _sentences
            ...
            for iii, sentence in enumerate(sentence_list):
                if sentence==current_sentence:
                    print(iii)
                    current_sentence_value_in_list=iii # keeps the current sentence starting value is sentence that did not work
                    break

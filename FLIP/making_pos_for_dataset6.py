# -*- coding: utf-8 -*-
"""
Created on Sun Mar 12 17:20:59 2023
...
for iiiii in range(2, storing):
        cell_obj1 = sheet.cell(row=iiiii, column = 1)
        sentence2 = cell_obj1.value
...
for iiii, sentence1 in enumerate(sentence_list):
    ...
    sheet[f'E{iiii+2}'] = str(sentence_list2)
    sheet[f'F{iiii+2}'] = str(subject_list_final2)
    sheet[f'G{iiii+2}'] = str(object_list_final2)
    sheet[f'H{iiii+2}'] = str(verb_list_final2)

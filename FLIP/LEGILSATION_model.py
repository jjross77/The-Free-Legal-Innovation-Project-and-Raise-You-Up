# -*- coding: utf-8 -*-
"""
Created on Thu Jul 20 18:11:38 2023
...
cur = conn.cursor()
cur.execute( f""" SELECT word, embedding, law_tag
                   FROM law_labels 
                   limit 50000
                    ;""")
...
torch.save(model.state_dict(), r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\Kimlichcova\legislation_model.pth")

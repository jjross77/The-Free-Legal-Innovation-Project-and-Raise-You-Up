# -*- coding: utf-8 -*-
"""
Created on Wed Mar  1 19:28:01 2023
...
def Run_model():
    ...
    for i in range(1, storing):
        ...
        if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\sentence_list.pickle") == True:#1
            with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\sentence_list.pickle","rb") as f2:
                sentence_list=pickle.load(f2) 

        

            
        if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\label_1_for_good_or_not_list.pickle") == True:#2
            with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\label_1_for_good_or_not_list.pickle","rb") as f3:
                label_1_for_good_or_not_list=pickle.load(f3) 
        ...
        if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\label_2_for_sentence_type_list.pickle") == True:#3
            with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\label_2_for_sentence_type_list.pickle","rb") as f4:
                label_2_for_sentence_type_list=pickle.load(f4) 



        if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\case_start_list.pickle") == True:#4
            with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\case_start_list.pickle","rb") as f5:
                case_start_list=pickle.load(f5) 
                break
    if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\existing_senteces_and_current_sentence.pickle") == False:# if_ not existing_sentences
        ...
        print(type(sentence_list_new[0]))
    ...
    if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\existing_senteces_and_current_sentence.pickle") == True:# if_existing _sentences
            with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\existing_senteces_and_current_sentence.pickle","rb") as f6:
                existing_senteces_and_current_sentence=pickle.load(f6) 
            ...
            last_case_looked_at=len(case_start_list_new)-1
    ...
    for  sentence_2, case_numm, label2, label1 in zip(sentence_list_new, case_start_list_new, label_2_for_sentence_type_list_new, label_1_for_good_or_not_list_new):
        ...
        if finding_words_to_remove_len >= 550:
            ...
            word_to_be_removed_for_next_iteration= finding_words_to_remove_from_sentence_list[40]
        ...
        try:
            ...
            with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\existing_senteces_and_current_sentence.pickle","w", encoding= "utf-8") as f8:
    ...
    embedding_file_name= f"dicttt_of_sentence_embeddings{doc_number}.pickle"
    embedding_path_name= r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\embedding_batches" + "\\" + embedding_file_name
    with open(embedding_path_name,"wb") as f:
        pickle.dump(dictt_of_sentence_embeddings, f9, pickle.HIGHEST_PROTOCOL)

# -*- coding: utf-8 -*-
"""
Created on Sun Mar  5 00:36:23 2023
...
def Run_model():
    ...
    tokenizer = AutoTokenizer.from_pretrained("nlpaueb/legal-bert-base-uncased", truncation_side="left")
    model = AutoModel.from_pretrained("nlpaueb/legal-bert-base-uncased").to("cuda").half()

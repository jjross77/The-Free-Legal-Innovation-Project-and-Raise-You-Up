# -*- coding: utf-8 -*-
"""
Created on Mon Feb 27 06:11:44 2023
...
def Run_model():
    ...
    if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\dicttt_of_sentence_embeddings.pickle") == True:
        with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\dicttt_of_sentence_embeddings.pickle","rb") as ff:
    ...
    for i, sentence_2, case_numm, label1, label2 in zip(range(1, len(sentence_list)),sentence_list, case_start_list, label_1_for_good_or_not_list, label_2_for_sentence_type_list):
        ...
        if i > num_of_embeddings:
            with open(r"D:\HPSCANS\existing_sentence_list_3.txt","a" , encoding="utf-8" ) as fff:
                fff.write(f"\n {existing_sentences} \n")
        ...
        if i > num_of_embeddings: # need to apply this else where
            ...
            try:
                ...
                if os.path.exists(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\dicttt_of_sentence_embeddings.pickle") == True:
                    ...
                    with open(r"C:\Users\yyyyyyyyyyyyyyyyyyyy\Documents\dicttt_of_sentence_embeddings.pickle","wb") as f:
